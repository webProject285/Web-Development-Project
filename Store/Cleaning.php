                    ...
                    <div class="row" id ="products">
                            <?php 
                                ...
                                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                    ...
                                    echo '<h5 class="card-title pt-3 pb-1 crop-text-2" id = "product'.$i.'"><a href=http://localhost/web/Store/productpage.php?q=' .$row['P_ID']. '>'.$row['P_FName'].'</a></h5>';                                    echo '</div>';
                                    if($row['P_Sale'] == 0){
