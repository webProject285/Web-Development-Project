...
        }
        };
        xmlhttp.open("GET",`sale.php?q=${str}`,true);
        xmlhttp.send();
        xmlhttp.open("GET",`onthego.php?q=${str}`,true);
        xmlhttp.send();
      }
      var sear = "";
      $(document).ready(function(){
        $("#searchButton").click(function(){
             ...
             $.ajax({
                type:"GET", url:'Search.php',data: {search: sear}
             });
    ...
    <div class="container-xxl">
      ...
      <div class="collapse navbar-collapse " id="main-nav">
        <div class="input-group mx-auto" style="max-width:600px;">
          <!--search-->
          <input id="searchText" type="search" class="form-control mr-sm-2" placeholder="Search" />
          <button id="searchButton" type="button" class="btn search-button" style="background-color: #f2e205 ">
