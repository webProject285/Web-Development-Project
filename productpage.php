...
<body class="bg-light text-dark">
  ...
  <nav class="navbar navbar-expand-sm bg-dark fixed-top ">
    <div class="container-xxl">
      <!-- navbar brand / title -->
      <a class="navbar-brand" href="metro1.html">
      ...
      <div class="collapse navbar-collapse " id="main-nav">
        <div class="input-group mx-auto" style="max-width:600px;">
          <!--TODO what's mr-sm-2-->
          <input id="search-input" type="search" id="search" class="form-control mr-sm-2" placeholder="Search" />
          <button type="button" class="btn search-button" style="background-color: #f2e205 ">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="#login&register">
              <button id="signin-button" type="button" class="btn btn-dark">
  ...
  <div class="h-100" style="position: fixed;z-index: 2;">
    <div class="d-flex align-items-center" style="min-height:90vh">
      ...
      <ul class="nav flex-column text-center">
        <!--Fresh Food-->
        <li>
          <a href="#" class="nav-link py-3 border-bottom tt shadow-lg" aria-current="page" title="">
            <span class="sideText">
        ...
        <!--Bakeries-->
        <li>
          <a href="#" class="shadow-lg nav-link py-3 border-bottom tt " title="">
            <span class="sideText">
        ...
        <!--baby care-->
        <li>
          <a href="#" class="shadow-lg nav-link py-3 tt" title="">
      ...
      <?php
        ...
        echo '<div class="col-fluid text-left col-7">';
          ...
          echo '<div class="col-fluid text-end">';
            ...
            echo '<button type="button" class="btn btn" id="c" style="background-color:#FFFFFF; box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.1);">-</button>';
              echo '<input type="text" class="form-control input-number" value="1" size="1" style="text-align:center; box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.1); border: 0;">';
              echo '<button type="button" class="btn btn" id="c" style="background-color:#FFFFFF; box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.1);">+</button>';
            echo '</div>';
            echo '<div class="btn-group" role="group">';
              echo '<button type="button" class="btn buy button-h">Add to Cart</button>';
            echo '</div>';
          echo '</div>';
        echo '</div>';
        ?>
